      ...
      <section id="team">
        <div className="container">
          <div className="row">
            ...
            <Link to={`/generals/${manstein?.sys.id}`}>
              <div className="card-wrapper col-md-4 col-sm-12  col-xl-4 wow fadeIn">
                <div className="card">
            ...
            <Link to={`/generals/${zhokov?.sys.id}`}>
              <div className="card-wrapper col-md-4 col-sm-12 col-xl-4 wow fadeIn">
                <div className="card">
                  <div className="card-images">
                    <div className="headcard">
